    ...
    switch (currentStep) {
      ...
      case 3:
        if (!formData.maxyId.trim()) {
          ...
          newErrors.maxyId = 'Oops! This Maxy ID isn’t in the correct format.';
        }
        break;
            ...
            <div className="flex items-center justify-between">
              {[1, 2, 3, 4].map((step) => (
                <div key={step} className="flex items-center">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 ${step < currentStep ? 'bg-[#50a8ff] text-white' :
                  ...
                  {step < 4 && (
                    <div
                      className={`w-12 h-0.5 mx-2 transition-all duration-300 rounded-full ${step < currentStep ? 'bg-[#50A8FF]' : 'bg-neutral-700'
                        }`}
                    />
                  )}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-neutral-900 rounded-xl p-4 border border-neutral-700">
                  ...
                  <p className="text-xs text-gray-400">
                    Must be at least 3 characters <br />
